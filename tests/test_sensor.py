...
from custom_components.aquanet_water_sensor.PpgReadingForMeter import (
    MeterReading,
    PpgReadingForMeter,
)
from custom_components.aquanet_water_sensor.sensor import AquanetSensor, AquanetInvoiceSensor, AquanetCostTrackingSensor
from custom_components.aquanet_water_sensor.Invoices import Invoices, InvoicesList


async def test_newer_takes_precedence(hass: HomeAssistant):
    """Aquanet sensor test - test_newer_takes_precedence."""
    # given
    aquanet_api = MagicMock()
    ...
    aquanet_api.readingForMeter = MagicMock(return_value=(
    ...
    sensor = AquanetSensor(hass, aquanet_api, "1", 2)
    # when
...
async def test_multiple_invocies(hass: HomeAssistant):
    """Aquanet sensor test - test_multiple_invocies."""
    aquanet_api = MagicMock()
    aquanet_api.invoices = MagicMock(return_value=(Invoices(invoices_list=[any_invoice(), any_invoice()],
                                                          code=0, message=None,
                                                          display_to_end_user=None,
                                                          token_expire_date=None, allow_load_after30_days=None,
                                                          has_non_paid_forecast=None,
                                                          token_expire_date_utc=None, end_user_message=None)))
    sensor = AquanetInvoiceSensor(hass, aquanet_api, '12', 1)
    await sensor.async_update()
    # then
...
async def test_a_price(hass: HomeAssistant):
    ...
    invoice.wear = 1
    aquanet_api.invoices = MagicMock(return_value=(Invoices(invoices_list=[invoice],
                                                          code=0, message=None,
                                                          display_to_end_user=None,
                                                          token_expire_date=None, allow_load_after30_days=None,
                                                          has_non_paid_forecast=None,
                                                          token_expire_date_utc=None, end_user_message=None)))
    sensor = AquanetCostTrackingSensor(hass, aquanet_api, '12', 1)
    await sensor.async_update()
    # then
...
async def test_latest_price(hass: HomeAssistant):
    ...
    aquanet_api.invoices = MagicMock(return_value=(Invoices(invoices_list=[old_invoice,new_invoice],
                                                          code=0, message=None,
                                                          display_to_end_user=None,
                                                          token_expire_date=None, allow_load_after30_days=None,
                                                          has_non_paid_forecast=None,
...
async def test_non_zero_latest_price(hass: HomeAssistant):
    ...
    aquanet_api.invoices = MagicMock(return_value=(Invoices(invoices_list=[zero_invoice,new_invoice],
                                                          code=0, message=None,
                                                          display_to_end_user=None,
                                                          token_expire_date=None, allow_load_after30_days=None,
                                                          has_non_paid_forecast=None,
